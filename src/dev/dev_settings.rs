...
use bevy::prelude::{BackgroundColor, Changed, Color, DetectChanges, Font, Handle, in_state, Interaction, IntoSystemConfigs, KeyCode, NextState, ResMut, State, States};
...
fn spawn_main(
    ...
    root.background_color(Color::DARK_GRAY)
        .justify_around();
...
const HOVER_BUTTON_COLOR: Color = Color::rgb(0.9, 0.9, 0.9);
